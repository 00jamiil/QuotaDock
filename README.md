...
This repository contains the `0.4.1-alpha` x64 implementation. It uses native WinUI 3/XAML on .NET 10 and Windows App SDK 2.3.1. It focuses on the four local AI coding agents that expose sign-in-based usage: Codex, Claude, Grok, and Kimi.
